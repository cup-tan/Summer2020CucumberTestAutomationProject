...
public class LoginStepDefinitions {
    ...
    public void user_should_see_dashboard_page() {
        ...
        Assert.assertEquals("Title is not correct!", expected, actual); // to do data validations, assert within the test
  ...
  // String expected = "Invalid user name or password.";
    ...
    public void user_verifies_that_message_is_displayed(String expected) throws InterruptedException {
