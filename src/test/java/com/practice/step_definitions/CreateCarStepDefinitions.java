...
import com.practice.pages.CreateCarPage;
...
public class CreateCarStepDefinitions {
     ...
     */
    @When("user adds new vehicle information")
    public void user_adds_new_vehicle_information(Map<String, String> dataTable) { //io.cucumber.datatable.DataTable dataTable
